...
public class OrdersBean {
	...
	public int getOr_shot() {
		return or_shot;
	}
	public void setOr_shot(int or_shot) {
		this.or_shot = or_shot;
	}
	public boolean isOr_whip() {
		return or_whip;
	}
	public void setOr_whip(boolean or_whip) {
		this.or_whip = or_whip;
	}
	public String getOr_io() {
		return or_io;
	}
	public void setOr_io(String or_io) {
		this.or_io = or_io;
	}
	public String getOr_hi() {
		return or_hi;
	}
	public void setOr_hi(String or_hi) {
		this.or_hi = or_hi;
	}
	public String getOr_comment() {
		return or_comment;
	}
	public void setOr_comment(String or_comment) {
		this.or_comment = or_comment;
	}
